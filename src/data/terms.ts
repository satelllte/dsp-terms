export const terms: Term[] = [
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        title:
          'Biquad in C - Center for Computer Research in Music and Acoustics',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      [
        'Most of ',
        {title: 'DAW', id: 'daw'},
        "'s have input and output buffers to help ensure artifact-free and CPU-overload free performance.",
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: ['I/O curve.', 'Amplitude plot of input to output.'],
  },
  {
    id: 'circular-buffer',
    ...
    links: [
      {
        ...
        title:
          'Feedback Comb Filters - Center for Computer Research in Music and Acoustics',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        title:
          'Complex Sinusoids as Circular Motion - Center for Computer Research in Music and Acoustics',
      },
    ],
  },
  {
    id: 'conjugation',
    title: 'Conjugation',
    paragraphs: ['Change the sign of the imaginary part of a complex number.'],
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        title:
          'Constructive vs Destructive Interference | Definition & Overview',
      },
      {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      [
        ...
        ' and ',
        {id: 'cross-correlation', title: 'cross correlation'},
        '.',
      ],
    ],
    links: [
      {
        ...
        title:
          'Dot Products and Correlation - Circles, Sines, and Signals - jackSchaedler',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        title:
          'What is the difference between dBV, dBu, dBV, dBm, dB? - TULARC',
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        title:
          'The Mathematics of the Discrete Fourier Transform (DFT) - Julius Smith',
      },
    ],
  },
  {
  ...
  },
  {
    id: 'filter',
    title: 'Filter',
    paragraphs: ['A formula or function for going from one signal to another.'],
    links: [
      {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      [
        'The transform is reversible. See ',
        {id: 'inverse-fourier-transform', title: 'Inverse Fourier transform'},
        '.',
      ],
    ],
  },
  ...
  },
  {
    ...
    paragraphs: ['A complex number storing amplitude, frequency, and phase.'],
  },
  {
    id: 'polar-form',
    title: 'Polar Form',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      [
        'The sample rate determines the highest frequency that can be stored. See ',
        {id: 'nyquist', title: 'Nyquist'},
        '.',
      ],
    ],
  },
  ...
  },
  {
    id: 'superposition',
    title: 'Superposition',
    expansion: 'Superposition principle (property)',
    paragraphs: [
  ...
  },
  {
    id: 'unity-gain',
    title: 'Unity gain',
    paragraphs: ['Input equals output.', 'Mostly used in audio engineering.'],
  },
  {
    id: 'upsample',
    title: 'Upsample',
